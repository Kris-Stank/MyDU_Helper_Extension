(() => {
  ...
  const TEMPLATES = [
    ...
    { id: "master-profile-direction", group: "Сведения о поступлении", title: "Профильная магистратура не реализуется", text: "В AITU реализуется только магистратура по научно-педагогическому направлению. Пожалуйста, измените академическую степень на «Магистратура (научно-педагогическое направление)»." },
    { id: "doctorate-directions", group: "Сведения о поступлении", title: "Докторантура по направлениям не реализуется", text: "В AITU реализуется только докторантура PhD. Пожалуйста, измените академическую степень на «Докторантура PhD»." },
    { id: "master-english-score", group: "Сведения о поступлении", title: "Балл по английскому языку ниже 25", text: "По английскому языку необходимо набрать не менее 25 баллов. Если баллы по английскому языку были конвертированы на основании результата IELTS, пожалуйста, прикрепите сертификат IELTS." },
    { id: "master-total-score", group: "Сведения о поступлении", title: "Общий балл КТ ниже 75", text: "Для поступления в магистратуру необходимо набрать по КТ не менее 75 баллов." },
